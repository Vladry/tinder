        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-lg-12 col-md-12 text-center">
                    <img src="${user.getUrlPhoto()?then (user.getUrlPhoto, 'https://robohash.org/68.186.255.198.png')}" alt="" class="mx-auto rounded-circle img-fluid"/>
                    <h3 class="mb-0 text-truncated"><<#if user.getName()??>${user.getName()}</#if></h3>
                    <br>
                </div>
